 ...
 *****************************************************************************/
#if (GFX_EXTERNAL_FONT_RASTER_BUFFER_SIZE < 14)
...
#error Please define "#define GFX_EXTERNAL_FONT_RASTER_BUFFER_SIZE (14)" in system_config.h.
#endif
 ...
 ***********************************/
const GFX_RESOURCE_HDR test_font_1 = 
{
